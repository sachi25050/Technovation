	...
	const quickActions = [
		{
			...
			route: "/admin/create-accounts"
		},
		{
			title: "Add Institution",
			description: "Register new institutions",
			route: "/admin/add-institution"
		},
		{
			title: "Create Awards",
			description: "Set up new awards and criteria",
			route: "/admin/add-awards"
		}
	];
