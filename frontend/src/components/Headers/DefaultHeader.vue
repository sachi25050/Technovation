<template>
	...
	<a-layout-header>
		...
		<div class="header-col header-btn">
			<a-button v-if="$root.$api && $root.$api.isAuthenticated()" type="link" @click="handleLogout">Logout</a-button>
			<a-button v-else href="https://www.creative-tim.com/product/muse-vue-ant-design-dashboard" target="_blank" type="primary" shape="round">FREE DOWNLOAD</a-button>
		</div>
	</a-layout-header>
	<!-- / Layout Header ( Navbar ) -->
