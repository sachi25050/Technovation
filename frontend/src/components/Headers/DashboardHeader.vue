		...
		<a-layout-header>
			<a-row type="flex">
				...
				<a-col :span="24" :md="18" class="header-control">
					...
					<a-button v-if="isAuthenticated()" type="link" @click="handleLogout">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M7 7V3H3v14h4v-4h6v-6H7z" fill="#111827"/>
							<path d="M14 10l-3 3v-2H8v-2h3V7l3 3z" fill="#111827"/>
						</svg>
						<span>Logout</span>
					</a-button>
...
import userRoleStore from '@/store/userRole';
	...
	export default ({
		...
		methods: {
			...
			// Check auth status helper for template
			isAuthenticated() {
